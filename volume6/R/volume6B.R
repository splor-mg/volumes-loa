# Organização do banco QUADRO GERAL DA RECEITA - Volume 1 
...
receita = trataReceita_Fiscal("bancos/SISOR/BASE_ORCAM_RECEITA_FISCAL_FONTE_STN.xlsx", TRUE)
...
final = final[merge!="Apenas no Banco X",] # Comente essa linha caso queira ver matrizes sem descrição
