...
dir_latex <- paste0(dir_loa, "/volume6/Rnw")
dir_codigosR <- paste0(dir_latex, "/CodigosR")
dir_utils <- paste0(dir_loa, "/utils/")
dir_data <- paste0(dir_loa, "/volume6/data")
...
getCodigoR(paste(dir_latex, "/Projeto_volume6B.Rnw", sep = ""), dir_codigosR)
...
\includepdf[pages={2}]{capaLOA.pdf}
\end{titlepage}
% \capa
...
\large{PORTARIA Nº 710, DE 25 DE FEVEREIRO DE 2021}
...
% INICIO QUADRO GERAL DA RECEITA
\ifthispageodd{ }{\afterpage{\null\thispagestyle{empty}\newpage}}
\phantomsection
%\addtocontents{toc}{\cftpagenumbersoff{section}}
\restoregeometry
\vspace*{9cm}
\addcontentsline{toc}{section}{ QUADRO GERAL DA RECEITA }
\centering \Huge {\textbf{QUADRO GERAL DA RECEITA}}
\afterpage{\null\thispagestyle{empty}\newpage}
\newpage
% \Pagina iniciando QUADRO GERAL DA RECEITA
...
\newpage
<<quadro_geral_da_receita, results=tex, echo=F>>=
  
  # INICIO TABELA
  
  dir_loa = gsub("(.+LOA).*", "\\1", getwd())
  dir_codigosR = paste0(dir_loa, "/volume6/Rnw/CodigosR")
  dir_utils = paste0(dir_loa, "/utils/")
  dir_data = paste0(dir_loa, "/volume6/data")
  dir_bancos = paste0(dir_loa, "/bancos")
  source(paste(dir_utils, "funcoes.R", sep=""))
  ...
  source(paste(dir_codigosR, "/Projeto_volume6B.R", sep=""), encoding = "UTF-8")
@
