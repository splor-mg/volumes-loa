...
<<parametros, echo=FALSE, results=hide>>=
  ...
  getCodigoR(paste0(dir_latex, "/T3_FUNFIP_DETALHAMENTO_DE_PESSOAL_INATIVO_CIVIL.Rnw"), dir_codigosR)
...
\includepdf[pages={5}]{capaLOA.pdf}
% \capa
...
@
 ...
 % Inicio: Contra Capa
%  \newgeometry{top=0cm, right=0cm, left=-6cm, bottom=0cm}
% \includepdf[pages={549},scale=1.1]{03_Volume_II_B.pdf}
 % Fim: Contra Capa
