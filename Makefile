...
DEPENDENCIAS_V2 := $(shell Rscript utils/makefile/gera_dependencias_v2.R 2> logs/log.Rout)
DEPENDENCIAS_V3 := $(shell Rscript utils/makefile/gera_dependencias_v3.R 2> logs/log.Rout)
DEPENDENCIAS_V4 := $(shell Rscript utils/makefile/gera_dependencias_v4.R 2> logs/log.Rout)
DEPENDENCIAS_V5 := $(shell Rscript utils/makefile/gera_dependencias_v5.R 2> logs/log.Rout)

acoes_planejamento := $(shell Rscript utils/makefile/ultimo_banco_mod.R bancos/SISOR/acoes_planejamento 2> logs/log.Rout)
#====================================================================
# PHONY TARGETS
...
clean: ## Organiza os arquivos auxiliares e outputs da compilação latex. Ex. argumento vol=5. origem=1 limpa o dir principal.
	@Rscript utils/limpaDir.R $(vol) $(origem)

format: ## Formata bancos brutos .xls e .txt
	@Rscript utils/formataBancos.R
...
pdf/Projeto_volume5.pdf: $(DEPENDENCIAS_V5)
	...
	@Rscript --encoding=utf-8 volume5/Rnw/CodigosR/Projeto_volume5.R 2> logs/warningsV5.Rout >&-
...
volume5/data/*.txt: volume5/R/volume5.R bancos/SISOR/BASE_QDD_FISCAL.xlsx bancos/manual/codigosPoder.xlsx bancos/manual/desc_classificacao_economica_despesa.xlsx
	...
	@Rscript --encoding=utf-8 $< 2>> logs/logv5.Rout


# Volume 4
pdf/Projeto_volume4.pdf: $(DEPENDENCIAS_V4)
	@echo "- Gera logs/warningsV4.Rout"
	@Rscript --encoding=utf-8 volume4/Rnw/CodigosR/Projeto_volume4.R 2> logs/warningsV4.Rout >&-
...
volume4/data/sumario_v4.txt: volume4/R/sumario_v4.R bancos/SISOR/BASE_QDD_INVESTIMENTO.xlsx bancos/manual/codigosPoder.xlsx bancos/SISOR/BASE_QDD_FISCAL.xlsx bancos/SISOR/BASE_DETALHAMENTO_OBRAS.xlsx
	...
	@Rscript --encoding=utf-8 $< 2>> logs/logv4.Rout
...
pdf/Projeto_volume3.pdf: $(DEPENDENCIAS_V3)
	...
	@Rscript --encoding=utf-8 volume3/Rnw/CodigosR/Projeto_volume3.R 2> logs/warningsV3.Rout >&-
...
volume3/data/consolidado/*.txt: volume3/R/V3_bancos_consolidados.R bancos/SISOR/BASE_QDD_INVESTIMENTO.xlsx $(acoes_planejamento)
	...
	@Rscript --encoding=utf-8 $< 2>> logs/logv3.Rout
...
pdf/Projeto_volume2A.pdf: $(DEPENDENCIAS_V2)
	@Rscript utils/Rnw2Tex.R 2A 2> logs/warningsV2A.Rout
	@echo "---------------------------------------------------------------"

pdf/Projeto_volume2B.pdf: $(DEPENDENCIAS_V2)
	@Rscript utils/Rnw2Tex.R 2B 2> logs/warningsV2B.Rout
	@echo "---------------------------------------------------------------"
...
volume1/data/T28_DCGF_PT4_Despesa_prevista_LOA.txt: volume1/R/T28_DCGF_PT4_Despesa_prevista_LOA.R volume1/R/T28_DCGF_Demonstrativo_programas_financiados_com_recursos_provenientes_Uniao.R bancos/SISOR/exec_desp_realizada.xlsx
	...
	@Rscript --encoding=utf-8 volume1/R/T28_DCGF_PT4_Despesa_prevista_LOA.R 2>> logs/logv1.Rout
