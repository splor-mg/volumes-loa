...
**Como usar:**
```bash
chmod +x _dev_ploa-2025-checkmain_fixes.sh
./_dev_ploa-2025-checkmain_fixes.sh
```
...
./_dev_ploa-2025-checkcheck_current_state.sh
```
...
./_dev_ploa-2025-checkfix_case_sensitivity.sh
```
...
./_dev_ploa-2025-checktest_all_volumes.sh
```
...
./_dev_ploa-2025-checkfix_filename_according_to_makefile.sh
```

### 6. `fix_normalize_covers.sh`
...
./_dev_ploa-2025-checkfix_normalize_covers.sh
```
...
./_dev_ploa-2025-checkfix_R_script_filenames_according_to_makefile.sh
```
...
./_dev_ploa-2025-checkfix_checks_filenames.sh
```
...
- O script de teste salva o log em `_dev_ploa-2025-check_volume7_test_output.log`
