...
<<results=tex, echo=FALSE>>=
  ...
  banco = ler_banco_txt(paste0(dir_data, "/T9_DEMONSTRATIVO_RECEITA_ORCAMENTARIA_CORRENTE_ORDINARIA.txt"))
  ...
  titulo1 = paste0("\\multicolumn{6}{c}{\\cellcolor{gray!50} \\textcolor{myblack} {\\footnotesize \\textbf{",
                   "DEMONSTRATIVO DA RECEITA ORÇAMENTÁRIA CORRENTE ORDINÁRIA}}} \\TBstrut  \\\\[2ex]\n")
  
  titulo2 = paste0("\\multicolumn{6}{c}{\\cellcolor{gray!50} \\textcolor{myblack} {\\footnotesize \\textbf{",
                   base_legal("T9_DEMONSTRATIVO_RECEITA_ORCAMENTARIA_CORRENTE_ORDINARIA"),
                   "}}} \\\\\n")
