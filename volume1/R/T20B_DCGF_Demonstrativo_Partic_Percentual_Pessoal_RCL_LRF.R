...
# Neste demonstrativo são deduzidas as despesas com a Fonte 58
...
#
# is_dtp_loa2016, deduz_f58 = TRUE = function(base){
#   base$DTP <- FALSE
...
vl_legisl = loa_desp[is_dtp_loa(loa_desp, deduz_f58 = TRUE) & 
...
vl_jud = loa_desp[is_dtp_loa(loa_desp, deduz_f58 = TRUE) & 
...
vl_pgj = loa_desp[is_dtp_loa(loa_desp, deduz_f58 = TRUE) & 
					(is_pgj(loa_desp)), sum(VL_DESP)]
perc_pgj = 0.02
...
vl_executivo = loa_desp[is_dtp_loa(loa_desp, deduz_f58 = TRUE) & 
						!(is_pgj(loa_desp) | is_legislativo(loa_desp) | 
...
vl_total = loa_desp[is_dtp_loa(loa_desp, deduz_f58 = TRUE), sum(VL_DESP)]
perc_total = 0.6
...
write.table(demonstr, "volume1/data/T20B_DCGF_Demonstrativo_Partic_Percentual_Pessoal_RCL_LRF.txt",
